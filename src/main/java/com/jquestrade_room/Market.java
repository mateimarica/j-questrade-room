...
public class Market {
	...
	public Market(String name, String[] tradingVenues, String defaultTradingVenue, String[] primaryOrderRoutes,
			String[] secondaryOrderRoutes, String[] level1Feeds, String[] level2Feeds, String extendedStartTime,
			String startTime, String endTime, String extendedEndTime, int snapQuotesLimit) {
		this.name = name;
		this.tradingVenues = tradingVenues;
		this.defaultTradingVenue = defaultTradingVenue;
		this.primaryOrderRoutes = primaryOrderRoutes;
		this.secondaryOrderRoutes = secondaryOrderRoutes;
		this.level1Feeds = level1Feeds;
		this.level2Feeds = level2Feeds;
		this.extendedStartTime = extendedStartTime;
		this.startTime = startTime;
		this.endTime = endTime;
		this.extendedEndTime = extendedEndTime;
		this.snapQuotesLimit = snapQuotesLimit;
	}
