...
public class Quote {
	...
	public Quote(String symbol, long symbolId, String tier, double bidPrice, int bidSize, double askPrice, int askSize,
			double lastTradePriceTrHrs, double lastTradePrice, int lastTradeSize, String lastTradeTick,
			String lastTradeTime, long volume, double openPrice, double highPrice, double lowPrice, int delay,
			boolean isHalted, double high52w, double low52w, double VWAP, ZonedDateTime timeOfCreation) {
		this.symbol = symbol;
		...
		this.lastTradePriceTrHrs = lastTradePriceTrHrs;
		this.lastTradePrice = lastTradePrice;
		this.lastTradeSize = lastTradeSize;
		this.lastTradeTick = lastTradeTick;
