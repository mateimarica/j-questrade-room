...
public class Order {
	...
	public Order(int id, String symbol, int symbolId, int totalQuantity, int openQuantity, Integer filledQuantity,
			String side, String orderType, double limitPrice, Double stopPrice, boolean isAllOrNone,
			boolean isAnonoymous, Integer icebergQuantity, Integer minQuantity, Double avgExecPrice,
			Double lastExecPrice, String source, String timeInForce, String gtdDate, String state,
			String rejectionReason, int chainId, String creationTime, String updateTime, String notes,
			String primaryRoute, String secondaryRoute, String orderRoute, String venueHoldingOrder,
			Double comissionCharged, String exchangeOrderId, boolean isSignificantShareHolder, boolean isInsider,
			boolean isLimitOffsetInDollar, int userId, Double placementCommission, Object[] legs, String strategyType,
			Double triggerStopPrice, int orderGroupId, String orderClass, boolean isCrossZero) {
		this.id = id;
		this.symbol = symbol;
