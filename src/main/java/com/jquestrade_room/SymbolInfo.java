...
public class SymbolInfo {
	...
	public SymbolInfo(String symbol, int symbolId, double prevDayClosePrice, double highPrice52, double lowPrice52,
			long averageVol3Months, long averageVol20Days, long outstandingShares, double eps, double pe,
			double dividend, double yield, String exDate, long marketCap, int tradeUnit, String optionType,
			String optionDurationType, String optionRoot, Object optionContractDeliverables, String optionExerciseType,
			String listingExchange, String description, String securityType, String optionExpiryDate,
			String dividendDate, String optionStrikePrice, boolean isTradable, boolean isQuotable, boolean hasOptions,
			String currency, MinTick[] minTicks, String industrySector, String industryGroup, String industrySubgroup,
		...
		this.averageVol20Days = averageVol20Days;
		...
		this.optionDurationType = optionDurationType;
		this.optionRoot = optionRoot;
		this.optionContractDeliverables = optionContractDeliverables;
